...
<body>
	<table style="width:100%" cellpadding="0" cellspacing="0">
		<tbody>
			<!-- <tr>
			 <td><img src="logo.jpeg" class="img-responsive" /></td>
				<td style="text-align:center; font-size:13pt; font-family:'Times New Roman'">
					<p style="margin:0;padding:0;">Republic of India</p>
					<p style="margin:0;padding:0;font-weight:bold;">APSIT</p>
					<p style="margin:0;padding:0;">Thane, Mumbai</p> 
				</td>
				<td><img src="logo.jpeg" class="img-responsive" style="visibility: hidden" /></td>
			</tr> -->
			<!-- <tr>
				<td></td>
